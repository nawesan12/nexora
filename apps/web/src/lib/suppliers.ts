...
import type { Proveedor } from "@pronto/shared/types";
...
export const proveedoresApi = {
  ...
  create: (data: import("@pronto/shared/schemas").ProveedorInput) =>
    api.post<Proveedor>("/api/v1/proveedores", data),
  update: (id: string, data: import("@pronto/shared/schemas").ProveedorInput) =>
